//
//  UIColor+getColor.swift
//  Mealmories
//
//  Created by Luciano Uchoa on 07/10/22.
//
...
extension UIColor {
    ...
    static var DarkBG4 = UIColor(named: "DarkBG4")!
    static var DarkText1 = UIColor(named: "DarkText1")!
    static var DarkText2 = UIColor(named: "DarkText2")!
    static var Vermelho = UIColor(named: "Vermelho")!
    static var Amarelo = UIColor(named: "Amarelo")!
}
